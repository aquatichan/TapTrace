...
struct RoadmapSheet: View {
    ...
    var body: some View { NavigationStack { ScrollView { VStack(alignment: .leading, spacing: 18) {
        ...
        if path == .protect { Link("Find EPA guidance on certified filters", destination: URL(string: "https://www.epa.gov/water-research/consumer-tool-identifying-point-use-and-pitcher-filters-certified-reduce-lead")!).buttonStyle(.borderedProminent) }
