...
struct SystemContext: Decodable, Sendable { var totalReported: Int?; var notYetClassified: Int?; enum CodingKeys: String, CodingKey { case totalReported = "total_reported"; case notYetClassified = "not_yet_classified" } }
